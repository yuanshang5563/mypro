...
public class CoreDictionariesGroup implements Serializable {
    ...
    // 非数据库字段
    private List<CoreDictionariesGroup> children;
    // 非数据库字段
    private String parentDictGroupNameName;
    // 非数据库字段
    ...
    public List<CoreDictionariesGroup> getChildren() {
        return children;
    }

    public void setChildren(List<CoreDictionariesGroup> children) {
        this.children = children;
    }

    public String getParentDictGroupNameName() {
        return parentDictGroupNameName;
    }

    public void setParentDictGroupNameName(String parentDictGroupNameName) {
        this.parentDictGroupNameName = parentDictGroupNameName;
    }
