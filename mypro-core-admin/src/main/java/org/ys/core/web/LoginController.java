...
import org.ys.core.vo.LoginBean;
...
public class LoginController {
    ...
    public HttpResult login(@RequestBody LoginBean loginBean, BindingResult bindingResult, HttpServletRequest request) throws Exception {
...
//        }
        ...
        return HttpResult.ok(responseEntity.getBody());
